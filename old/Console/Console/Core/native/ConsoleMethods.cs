...
namespace _Console.Core.native
{
    public class ConsoleMethods
    {
        ...
        // public delegate type to be used as the Handler Routine for SCCH
        ...
        [DllImport("kernel32.dll", SetLastError = true)]
        public static extern bool SetConsoleCtrlHandler(HandlerRoutine _HandlerRoutine, bool Add);
