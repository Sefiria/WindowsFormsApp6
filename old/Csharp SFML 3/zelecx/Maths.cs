...
namespace zelecx
{
    static public class Maths
    {
        ...
        static public Point PositionTile(Point position) => new Point(position.X / _Main.TileSize + Global.CameraPosition.X, position.Y / _Main.TileSize + Global.CameraPosition.Y);
