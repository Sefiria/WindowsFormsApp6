...
{
    public partial class SurvivalMaxMode : Mode
    {
        public override long Score { get => m_Score; set { } }

        public SurvivalMaxMode()
        {
            InitializeComponent();
        }
        public override void Initialize()
        {
            ...
            m_Score = Grid.BlockCount * Grid.BlockCount;
        ...
        private void Draw(object sender, EventArgs e)
        {
            ...
            this.Text = $"Survival MAX - Score : {Score}    Best : {FileData.SurvivalMaxScore}";
        }
        ...
        public override void BlockClickEnded(int X, int Y)
        {
            ...
            if (!NotDoneYet)
            {
                ...
                {
                    MessageBox.Show($"Not more combo : The game ends.\nScore : {Score}\nBest Score : {FileData.SurvivalMaxScore}", "Game Over");
                }
                Close();
            }
        }
