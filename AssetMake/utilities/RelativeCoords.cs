...
namespace AssetMake.utilities
{
    internal class RelativeCoords
    {
        ...
        public static int Middle() => Core.rw / 2;
        public static int Right(int margin = 0) => Core.rw - 1 - margin;
        public static int Top(int margin = 0) => margin;
        public static int Center() => Core.rh / 2;
        public static int Bottom(int margin = 0) => Core.rh - 1 - margin;
    }
}
