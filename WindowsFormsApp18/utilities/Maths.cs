...
namespace WindowsFormsApp18.Utilities
{
    public static class Maths
    {
        ...
        public static vecf Normale(vecf a, vecf b) => new vecf(b.y - a.y, a.x - b.x) * (1F / Distance(a, b));
        ...
        public static bool CollisionBoxSegment(Box box, vecf a, vecf b)
        {
            float last_t = -1F;
            for (float t = 0F; t <= 1F; t += 0.01F / Math.Min(box.w, box.h))
            {
                ...
                if (box.rectf.Contains(Lerp(a, b, t).pt))
                    return true;
            }
            return false;
        }
