...
{
    public partial class PerspectiveGrid : Control
    {
        ...
        {
            DrawGrid(10, 30, 200, e.Graphics);

            DrawSensor(new Point3D(80, 20, 300), new Point3D(80, 20, 100), e.Graphics);
            DrawSensor(new Point3D(240, 140, 300), new Point3D(240, 140, 020), e.Graphics);
        }
