...
namespace WindowsFormsApp21Isometric
{
    public class Map
    {
        ...
        private readonly Point MAP_SIZE = new Point(6, 4);
        private readonly Point TILE_SIZE;
        private readonly Vector2 MAP_OFFSET = new Vector2(2.5f, 2);
        ...
        {
            Vector2 cursor = new Vector2(mousePos.X - (int)(MAP_OFFSET.X * TILE_SIZE.X), mousePos.Y - (int)(MAP_OFFSET.Y * TILE_SIZE.Y));
        ...
        public void Update()
        {
            ...
            if (InputManager.Direction != Point.Empty)
            {
