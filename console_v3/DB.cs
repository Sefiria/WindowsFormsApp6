    ...
    */
    ...
    public static class DB
    {
        ...
        public enum Tex { UnbreakableRock = 0x0 + 0x0 * 16, Obsidian = 0x1 + 0x0 * 16, HardRock = 0x2 + 0x0 * 16, DeepRock = 0x3 + 0x0 * 16, Rock = 0x4 + 0x0 * 16,
            ...
            WoodAxe = 0x0 + 0x4 * 16, WoodScythe = 0x1 + 0x4 * 16, WoodPickaxe = 0x2 + 0x4 * 16, WoodShovel = 0x3 + 0x4 * 16, WoodSword = 0x4 + 0x4 * 16,
            IronAxe = 0x0 + 0x5 * 16, IronScythe = 0x1 + 0x5 * 16, IronPickaxe = 0x2 + 0x5 * 16, IronShovel = 0x3 + 0x5 * 16, IronSword = 0x4 + 0x5 * 16,
            GoldAxe = 0x0 + 0x6 * 16, GoldScythe = 0x1 + 0x6 * 16, GoldPickaxe = 0x2 + 0x6 * 16, GoldShovel = 0x3 + 0x6 * 16, GoldSword = 0x4 + 0x6 * 16,
            DiamondAxe = 0x0 + 0x7 * 16, DiamondScythe = 0x1 + 0x7 * 16, DiamondPickaxe = 0x2 + 0x7 * 16, DiamondShovel = 0x3 + 0x7 * 16, DiamondSword = 0x4 + 0x7 * 16,
            EmeraldAxe = 0x0 + 0x8 * 16, EmeraldScythe = 0x1 + 0x8 * 16, EmeraldPickaxe = 0x2 + 0x8 * 16, EmeraldShovel = 0x3 + 0x8 * 16, EmeraldSword = 0x4 + 0x8 * 16,
        ...
        public static List<int> Collectibles = Items.Concat(Consumables).Concat(Structures).ToList();
        ...
        public static Ores_Base GetOre(int dbref_ore)
        {
            ...
            {
                default: return null;
                case (int)Tex.WoodLog: return Ores_Wood.Instance;
